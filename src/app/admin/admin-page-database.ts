...
import { DriveFileCommand } from '@app/gapi/drive-file-command.service';
...
export class AdminPageDatabase {
  constructor(
    private driveFileCommand: DriveFileCommand,
  ...
  add(pageToAdd: Page) {
    ...
    return this.get().pipe(
      switchMap(_ => {
        ...
        return this.driveFileCommand.execute(this.pageDatabase.fileId, this.pageDatabase.pages).pipe(
          switchMap(x => {
